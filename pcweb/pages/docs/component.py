        ...
        rx.grid(
            *[
                rx.tooltip(
                    rx.box(
                        bg=f"var(--{color}-9)",
                        class_name="rounded-md size-8 shrink-0"
                    ),
                    content=color,
                    delay_duration=0,
                )
    ...
    return [
        rx.table.cell(
            rx.box(
                ...
                hovercard(
                    rx.icon(
                        tag="info", size=15, class_name="!text-slate-9 shrink-0",
                    ),
            ...
            rx.box(
                ...
                rx.cond(
                    ...
                    hovercard(
                        ...
                        rx.text(f"Union[{', '.join(all_types)}]", class_name="font-small text-slate-11"),
                    ),
                ),
                rx.cond(
